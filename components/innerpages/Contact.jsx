              ...
              <div className="panel row child-cols-12 lg:child-cols-6 g-0">
                  ...
                  <div className="panel overflow-hidden rounded-3 h-100 min-h-350px">
                    <figure className="panel h-100 m-0 rounded">
                      ...
                      <Image
                        ...
                        alt="Hero image"
                        src="/assets/images/contact/c1.jpg"
                        width="1500"
                        height="1000"
                      />
                    </figure>
                ...
                <div className="order-0 lg:order-1">
                  ...
                  >
                    ...
                    <div className="mt-4 p-3 border rounded bg-white dark:bg-gray-900 dark:text-white">
                      ...
                      <div style={{ flexWrap: "wrap"}} className="d-flex lg\:justify-between gap-1">
                        {[
